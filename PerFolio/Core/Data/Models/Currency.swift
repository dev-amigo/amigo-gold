...
struct Currency: Identifiable, Codable, Equatable, Hashable {
    ...
    static let popularCurrencies: [Currency] = [
        ...
        Currency(id: "AED", name: "UAE Dirham", symbol: "د.إ", flag: "🇦🇪", conversionRate: 3.67, region: .middleEast, isPopular: true),
        Currency(id: "SAR", name: "Saudi Riyal", symbol: "﷼", flag: "🇸🇦", conversionRate: 3.75, region: .middleEast, isPopular: true),
